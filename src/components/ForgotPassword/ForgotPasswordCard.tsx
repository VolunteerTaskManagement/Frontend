...
// //       /*
// //        * The current backend contract requires oldPassword.
// //        * Since the four-digit step is mocked, the entered code
// //        * is temporarily sent as oldPassword.
// //        */
...
//     // The verification-code step is intentionally mocked.
//     // Any four-digit value moves to the next step.
//     if (numericCode.length === 4) {
//       setStep("password");
//     }
//   };
...
//       // The same ForgotPassword API is used to request a new code.
//       const response = await forgotPassword(
//         userName.trim()
//       );
...
//       // Use the existing reset-password API from the project.
//       const response = await ChangeForgotPassword({
